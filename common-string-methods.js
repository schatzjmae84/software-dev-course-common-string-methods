...
*/
let text = "Learning JavaScript if fun!";
...
let transformedString = newString.replace("bootcamp", "JavaScript");
...
let newReceipt = receipt.slice(10, 18);
console.log(newReceipt);
let newOrder = receipt.slice(26, 46).split(",");
console.log(newOrder);
let newTotal = receipt.slice(-13).toUpperCase();
